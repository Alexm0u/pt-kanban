      ...
      <div
        className={
          isSideBarOpen
            ...
            : `bg-[#007BFF] dark:bg-[#2b2c37] dark:hover:bg-[#fca5a5] top-auto bottom-10 justify-center items-center hover:opacity-80 cursor-pointer p-0 transition duration-300 transform fixed felx w-[56px] h-[48px] rounded-r-full`
        }
      >
        <div>
          {/* reWrite modal  */}
              ...
              <div className="dropdown-borad flex flex-col h-[70vh]  justify-between">
                <div>
                  {boards.map((board, index) => (
                    <div
                      className={`flex items-baseline space-x-2 px-5 mr-8 rounded-r-full duration-500 ease-in-out py-4 cursor-pointer hover:bg-[#635fc71a] hover:text-[#0f766e] dark:hover:bg-white dark:hover:text-[#635fc7] dark:text-white  ${
                        board.isActive &&
                        "bg-[#0f766e] rounded-r-full text-white mr-8"
                      } `}
                      key={index}
                      onClick={() => {
                  ...
                  <div
                    className="flex  items-baseline space-x-2  mr-8 rounded-r-full duration-500 ease-in-out cursor-pointer text-[#0f766e] px-5 py-4 hover:bg-[#635fc71a] hover:text-[#635fc7] dark:hover:bg-white  "
                    onClick={() => {
